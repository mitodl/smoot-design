// From https://tiptap.dev/docs/editor/api/utilities/static-renderer
...
function TiptapEditor() {
  const [tab, setTab] = useState<
    "react" | "html" | "html-element" | "markdown"
  >("react")
    ...
    <div>
      ...
      {tab === "react" && (
        <div className="output-group tiptap">
          <h2>React Element</h2>
          <p>
            This example renders the JSON content directly into a React element
            without using an editor instance.
          </p>
          <p className="hint">
      ...
      {tab === "html" && (
        <div className="output-group tiptap">
          <h2>HTML String</h2>
          <p>
            This example renders the JSON content into an HTML string without
            using an editor instance or document parser.
          </p>
          <pre>
            <code>
              {currentJSON &&
      ...
      {tab === "html-element" && (
        <div className="output-group tiptap">
          ...
          <p>
            This example renders the JSON content into an HTML string without
            using an editor instance or document parser, and places that result
            directly into the HTML using dangerouslySetInnerHTML.
          </p>
          <div
            className="tiptap"
      ...
      {tab === "markdown" && (
        <div className="output-group tiptap">
          <h2>Markdown</h2>
          <p>
            This example renders the JSON content into a markdown without using
            an editor instance, document parser or markdown library.
          </p>
          <pre>
            <code>
              {currentJSON &&
