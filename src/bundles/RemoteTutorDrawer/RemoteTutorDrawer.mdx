...
The RemoteTutorDrawer is an AiChat Drawer controlled "remotely" via messages from iframes. An example use case is within Open edx courses:

- The RemoteTutorDrawer is rendered in the learning MFE
